...
FILES=/home/s-kim-lab/baxter_ws/src/apriltag_ros/apriltag-imgs/custom/*.png  # Set the folder to convert from

# Set the desired width of your tags
width=20.0         # [mm]  Set the desired width in real units
...
grid_h=5           # [num] Number of rows
grid_w=7           # [num] Number of columns
